...
import com.expensemanager.security.LoggedOutTokenService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public ApiResponse<?> register(RegisterRequest request) {
        ...
        otpEntity.setExpiryTime(LocalDateTime.now().plusSeconds(30));
    ...
    public ApiResponse<Void> logout(String token) {
        ...
        loggedOutTokenService.logout(token);
